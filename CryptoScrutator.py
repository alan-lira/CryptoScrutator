...
class CryptoScrutator:
   ...
   def executeSimpleRNNModel(self):
      ...
      if self.plot_loss_graph_boolean == True:
         ...
         simplernn_trainned_model_metrics_history = self.recurrentNeuralNetworkManager.getTrainnedModelMetricsHistory()
      ...
      simplernn_prediction_history = self.recurrentNeuralNetworkManager.getPredictionHistory()

      ## REVERT NORMALIZING STEP (INVERSE TRANSFORM)
      self.simplernn_predicted_prices = self.datasetManager.inverseTransformData(simplernn_prediction_history)
   ...
   def executeLSTMModel(self):
      ...
      if self.plot_loss_graph_boolean == True:
         ## PLOT GRAPH: (X = 'Number of Epochs', Y = 'Training Loss' Vs 'Validation Loss')
         lstm_trainned_model_metrics_history = self.recurrentNeuralNetworkManager.getTrainnedModelMetricsHistory()
      ...
      ## PREDICT WITH TRAINNED MODEL
      self.recurrentNeuralNetworkManager.predictWithTrainnedModel(self.normalized_testing_data_to_predict_chunk)
      lstm_prediction_history = self.recurrentNeuralNetworkManager.getPredictionHistory()

      ## REVERT NORMALIZING STEP (INVERSE TRANSFORM)
      self.lstm_predicted_prices = self.datasetManager.inverseTransformData(lstm_prediction_history)
   ...
   def executeGRUModel(self):
      ...
      if self.plot_loss_graph_boolean == True:
         ## PLOT GRAPH: (X = 'Number of Epochs', Y = 'Training Loss' Vs 'Validation Loss')
         gru_trainned_model_metrics_history = self.recurrentNeuralNetworkManager.getTrainnedModelMetricsHistory()
      ...
      ## PREDICT WITH TRAINNED MODEL
      self.recurrentNeuralNetworkManager.predictWithTrainnedModel(self.normalized_testing_data_to_predict_chunk)
      gru_prediction_history = self.recurrentNeuralNetworkManager.getPredictionHistory()

      ## REVERT NORMALIZING STEP (INVERSE TRANSFORM)
      self.gru_predicted_prices = self.datasetManager.inverseTransformData(gru_prediction_history)
...
cryptoScrutator.executeSimpleRNNModel() ## EXECUTE SIMPLERNN LAYER BASED MODEL
cryptoScrutator.executeLSTMModel() ## EXECUTE LSTM LAYER BASED MODEL
cryptoScrutator.executeGRUModel() ## EXECUTE GRU LAYER BASED MODEL
