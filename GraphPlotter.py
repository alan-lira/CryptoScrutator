...
class GraphPlotter:
   ...
   def plotOneCurveGraph(self, graph_title, dataset, y_label, y_data, x_label, x_data, x_ticks_size, x_ticks_rotation):
   ...
   def plotTwoCurvesGraph(self, graph_title, y_label, first_curve_label, first_curve_color, first_curve_data, second_curve_label, second_curve_color, second_curve_data, x_label, x_ticks_size):
      pyplot.figure(figsize = (self.a4_height, self.a4_width), dpi = self.dpi, facecolor = self.facecolor, edgecolor = self.edgecolor)
